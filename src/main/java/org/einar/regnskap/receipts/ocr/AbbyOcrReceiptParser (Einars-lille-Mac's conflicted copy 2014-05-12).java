...
public class AbbyOcrReceiptParser implements ReceiptParser {
    ...
    public Receipt parseFromFile(String filename) {
        ...
        try {
            receiptData = readFromFile(filename + ".xml");
        } catch (Exception e) {
        ...
        r.setItems(itemsFinderResult.getItems());

        new ReceiptFrame(r);


        for (Item i : itemsFinderResult.getItems()) {
    ...
    public static void main(String[] args) {
        ...
        //new AbbyOcrReceiptParser().parseFromFile("kvitteringREMA1000_8");
    }
